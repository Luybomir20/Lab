...
public class CustomDouble {
        ...
        private final int first;//Ціла частина
        private final double second;//Дробова

        public CustomDouble(final int first, final double second) {//Коснтруктор на задання чисел
            this.first = first;
            this.second = second;
        }
